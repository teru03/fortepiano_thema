...
<?php wp_head(); ?>
	...
	<meta property="og:image" content="<?php echo get_eyechatch_url("large") ?>"/>
	...
	<meta name="twitter:image" content="<?php echo get_eyechatch_url("medium") ?>" />
	<meta name="twitter:description" content="<?php if(is_single()){echo mb_substr(get_the_excerpt(), 0, 50); } else{ bloginfo('description');} ?>" />
